...
chi=0.1 	                   # upper bound on the exclusion region (in unit number density)
...
Nc=100                          # Number of configurations
...
acceptance 0.1 0.2 samples_tfin 50 500  run " > log1 #\
